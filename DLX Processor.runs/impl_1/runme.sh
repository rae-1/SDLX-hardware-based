...
HD_PWD='C:/Users/Yashraj Deshmukh/Desktop/Group_13_assignment_2/DLX processor/DLX Processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log instructionRegister.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source instructionRegister.tcl -notrace
