...
HD_PWD='C:/Users/Yashraj Deshmukh/Desktop/Group_13_assignment_2/DLX processor/DLX Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instructionRegister.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instructionRegister.tcl
